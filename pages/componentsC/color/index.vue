	...
	<view class="wrap">
		<view class="item">
			...
			<view class="color-box">
				<view class="color-item" style="background: #1e8dff;">
				...
				<view class="color-item" style="background: #ebf8ff;">
					<view class="color-title">
						Disabled
					</view>
					<view class="color-value">
		...
		<view class="item">
			...
			<view class="color-box">
				<view class="color-item" style="background: #ff4e47;">
					<view class="color-title">
						Error
					</view>
					<view class="color-value">
				...
				<view class="color-item" style="background: #ffeeeb;">
					<view class="color-title">
						Disabled
					</view>
					<view class="color-value">
		...
		<view class="item">
			...
			<view class="color-box">
				<view class="color-item" style="background: #ff8200;">
					<view class="color-title">
						Warning
					</view>
					<view class="color-value">
				...
				<view class="color-item" style="background: #fff7e6;">
					<view class="color-title">
						Disabled
					</view>
					<view class="color-value">
		...
		<view class="item">
			...
			<view class="color-box">
				<view class="color-item" style="background: #52c41a;">
					<view class="color-title">
						Success
					</view>
					<view class="color-value">
				...
				<view class="color-item" style="background: #f6ffed;">
					<view class="color-title">
						Disabled
					</view>
					<view class="color-value">
		...
		<view class="item">
			...
			<view class="color-box">
				<view class="color-item" style="background: #262626;">
					<view class="color-title">
						主标题/重要标题
					</view>
					<view class="color-value">
				...
				<view class="color-item" style="background: #595959;">
					<view class="color-title">
						常规文本/辅助文本/描述文本/正文
					</view>
					<view class="color-value">
				...
				<view class="color-item" style="background: #8c8c8c;">
					<view class="color-title">
						副标题/次级标题
					</view>
					<view class="color-value">
				...
				<view class="color-item" style="background: #bfbfbf;">
					<view class="color-title">
						暗文本/未输入
					</view>
					<view class="color-value">
